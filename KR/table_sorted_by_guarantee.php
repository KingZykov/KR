<html>
<head>
    <title> Сортировка По Гарантии </title>
...
<div class="wrapper">
<main class="main">
<h2>Список продуктов, отсортированных по гарантии:</h2>
<table border="1">
    <!--  // вывод «шапки» таблицы -->
    <thead>
        <tr class='sticky'>
    ...
    $sql_add = "Select * from " . $_GET['table9'];
        ...
        // print($sql_add);
        $result = $mysqli->query('SELECT * FROM bt order by guarantee'); // запрос на выборку сведений о пользователях
