<html>
<head>
    <title> Фильтриция Продуктов </title>
...
<table border="1">
    ...
    <?php
        ...
        $sql_add = 'SELECT * FROM bt WHERE manufacturer = "' . $_GET['id13'] . '"';
        //$sql_add = 'SELECT * FROM `bt`';
        print("Производитель = " . $_GET['id13']);
        $result = $mysqli->query($sql_add); // запрос на выборку сведений о пользователях
